...
import { requireRole, createUserSession, getDefaultRedirectForRole } from "~/sessions.server";
import { getUserById, updateUser } from "~/auth/users.server";
import { userEditSchema } from "~/lib/user.schema";
import { Settings, Mail, Lock, Shield } from "lucide-react";
...
export async function action({ request }: Route.ActionArgs) {
	...
	try {
		...
		// Update session if email or role changed
...
export default function AdminSettingsPage({ actionData, loaderData }: Route.ComponentProps) {
